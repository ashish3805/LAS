...
.service('accountSrvAdmin',function ($http) {
	var self=this;
	self.getProfile=function () {
		return $http.get('/profile/admin');
	}
	self.saveProfile=function (data) {
		return $http.put('/profile/admin',data);
	}
	self.updatePassword=function (data) {
		return $http.put('/signup/admin',data);
	}

})
.controller('accountCtrlAdmin',['$scope','accountSrvAdmin',function ($scope,accountSrv) {
	
	console.log("strlAdminAcoount");
	var self=$scope;
	self.profile='';
...
.controller('editPassAdmin',['$scope','accountSrvAdmin',function ($scope,accountSrv) {
	var self=$scope;
	self.password='';
	self.rePassword='';
	self.editPassword={
